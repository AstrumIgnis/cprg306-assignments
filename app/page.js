...
export default function Home() {
  return (
    <main>
      ...
      <Link className="m-4" href="/week-7">Week 7 Assignment</Link><br />
      <Link className="m-4" href="/week-8">Week 8 Assignment</Link><br />
      <Link className="m-4" href="/week-9">Week 9 Assignment</Link><br />
      <Link className="m-4" href="/week-10">Week 10 Assignment</Link>
    </main>
  );
}
